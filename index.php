    ...
    <section class="portfolio light-gray-bg padding-top-70 padding-bottom-20">
      ...
      <div class="ajax-work col-3"> 
        ...
        <div class="cbp-item ana dial growth">
          <article class="item"><img class="img-responsive" src="images/services/2managed_it.png" alt="" > 
            <!-- Hover -->
        ...
        <div class="cbp-item ana dial sec storage">
          <article class="item"><img class="img-responsive" src="images/services/2cloud_migration.png" alt="" > 
            <!-- Hover -->
            <div class="over-detail"> 
              <!-- Link -->
        ...
        <div class="cbp-item ana sec storage">
          <article class="item"><img class="img-responsive" src="images/services/3salesforce.png" alt="" > 
            <!-- Hover -->
            <div class="over-detail"> 
              <!-- Link -->
        ...
        <div class="cbp-item sec storage">
          <article class="item"><img class="img-responsive" src="images/services/1mobile_application.png" alt="" > 
            <!-- Hover -->
            <div class="over-detail"> 
              <!-- Link -->
        ...
        <div class="cbp-item ana sec">
          <article class="item"><img class="img-responsive" src="images/services/3iot.png" alt="" > 
            <!-- Hover -->
            <div class="over-detail"> 
              <!-- Link -->
        ...
        <div class="cbp-item ana dial direc">
          <article class="item"><img class="img-responsive" src="images/services/1custom_app.png" alt="" > 
            <!-- Hover -->
            <div class="over-detail"> 
              <!-- Link -->
